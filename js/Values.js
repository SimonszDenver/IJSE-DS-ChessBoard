...
var Sq120ToSq64 = new Array(BOARD_SQUARE_NUM);
...
function HASH_PCE(pce, sq) {
	ChessBoard.posKey ^= PieceKeys[(pce * 120) + sq];
}

function HASH_CA() { ChessBoard.posKey ^= CastleKeys[ChessBoard.castlePerm]; }
function HASH_SIDE() { ChessBoard.posKey ^= SideKey; }
function HASH_EP() { ChessBoard.posKey ^= PieceKeys[ChessBoard.enPas]; }
